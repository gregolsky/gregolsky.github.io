---
title: "Trying out Harp"
description: "Few words about Harp — a Node.js web server simplifying frontend development workflow with built-in transpilers and convention-over-configuration."
pubDate: 2015-08-30
cover: "../../assets/articles/harp.jpg"
coverAlt: "Trying out Harp"
tags: ["frontend", "tool", "webserver", "transpilers", "markdown", "scss", "jade", "nodejs"]
---
...
As this blog was created using Harp, do not forget to check out [the source](https://github.com/gregolsky/gregolsky.io) or try Harp on your own. There is a great developer's guide on Harp's website and some ready to use recipes like for building a blog. Go check! See ya.
